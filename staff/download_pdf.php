...
<body>
    ...
    <div class="action-buttons">
        <button onclick="printWithTimestamp()" class="btn btn-primary">
            🖨️ Print / Save as PDF
        </button>
    ...
    <div class="footer">
        <p>Generated by <span class="footer-logo">Qubo Labs</span> on <span id="generation-timestamp"><?php echo date('F d, Y'); ?></span></p>
